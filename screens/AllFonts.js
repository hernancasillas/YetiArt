...
export default class AllFonts extends React.Component {
	constructor(props) {
		super(props);
		this.state = {
			loading: true,
			...
			return (
				<View style={{ flex: 1 }}>
					...
					>
						...
						<View style={{ flex: 1 }}>
							<UbuntuBoldText style={styles.textStyle}>Fonts Online</UbuntuBoldText>
							...
							<FlatList
								...
								renderItem={({ item }) => (
									...
									>
										...
										<UbuntuRegularText style={{ fontSize: 40 }}>
											{item.family_name}
										</UbuntuRegularText>
									</TouchableOpacity>
								)}
